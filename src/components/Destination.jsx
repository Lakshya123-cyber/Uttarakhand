  ...
  return (
    <section>
      <div className="destination">
        ...
        <p className="para">Do explore them once, they are worth!</p>
        ...
        <DestinationData
          ...
          img1="/images/gangotri.jpg"
          img2="/images/gang.jpg"
        />
        <DestinationData
          className="first-des"
          heading="Yamunotri"
