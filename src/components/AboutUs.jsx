  ...
  return (
    <div className="about-container" style={{ fontFamily: "Open Sans" }}>
      ...
      <p>
        ...
        following work opportunities. As more families came to Singapore and the
        unique surnames from Uttrakhand started appearing in offices and
        organisations, the group members would organically connect and extend a
        warm welcome with a potluck or a simple barbeque in the park, to help
        create a sense of support. Tied together with the common threads of
        cuisine, music, celebrations and the longing to hold on to our roots,
      ...
      <p>
        ...
        promotion and celebration of Uttarakhand culture and heritage. We strive
